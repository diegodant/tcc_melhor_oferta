<%-- 
    ...
    Created on : Nov 22, 2012, 4:53:04 AM
...
<table width="100%">
    ...
    <table border="0" cellpadding="0" cellspacing="1">
        <form method="post"  action="..\ControleVendedor?cmd=gravar_empresa_categoria" name="Filtro">
                <tr>
    ...
    List<Vendedor>lista = vd.listarVendedorAll();
        for(Vendedor v1 : lista){
    
    %>            
            
                <tr>
                <td class="texto-tabela">
                    <input type="text" name="Tipo" size="20" class="Form" value='<% out.print(v1.getUsuario().getTipo()); %>'/>
                </td>
                <td class="textos-tabela">
                    <input type="text" name="RazaoSocial" size="20" class="Form" value='<% out.print(v1.getCategorias().getNome()); %>'/>
                </td>
                <td class="textos-tabela">
                    <input type="text" name="NomeFantasia" size="20" class="Form" value='<% out.print(v1.getCategorias().getNome()); %>'/>
                </td>
                <td class="textos-tabela">
                    <input type="text" name="Responsavel" size="22" class="Form" style="height: 18px" value='<% out.print(v1.getCategorias().getNome()); %>'/>
                </td>
                <td class="textos-tabela">
                    <input type="text" name="CNPJ" size="20" class="Form" value='<% out.print(v1.getUsuario().getDocumento()); %>'/>
                </td>


                <td class="textos-tabela">
                <input type="text" name="Login" size="20" class="Form" value='<% out.print(v1.getUsuario().getLogin()); %>'/></td>
                <td class="textos-tabela">
                <input name="paPagina" type="hidden" value="<=loPagina%>" />
                <a href="empresa_edita.jsp?nvendedor=<% out.print(v1.getUsuario().getNusuario()); %>">
