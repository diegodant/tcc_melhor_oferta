...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><font face="Arial, Helvetica, sans-serif" color="#999999"  size="2">Óla, Nome da empresa ou cliente</font></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  <tr>
    <td><font face="Arial, Helvetica, sans-serif" color="#999999"  size="2">Faça sua avaliação sobre a negociação feita. Clique no link abaixo e acompanhe:</font></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
