...
<body onload="MM_preloadImages('imagens/painel_empresa/btn_acompanhar_solicitacao2.jpg','imagens/painel_empresa/btn_alterar_descricao2.jpg','imagens/painel_empresa/btn_atualizar_logotipo2.jpg','imagens/painel_empresa/btn_atualizar_fotos2.jpg','imagens/painel_empresa/btn_alterar_plano2.jpg','imagens/painel_empresa/btn_avaliacao2.jpg','imagens/painel_empresa/btn_limite_plano2.jpg','imagens/painel_empresa/btn_sair2.jpg')">
<div id="principal">
    ...
    <td>
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="160" valign="top"><img src="imagens/painel_empresa/tit_painel_empresa.jpg" width="252" height="17" alt="Painel de Controle Empresa" title="Painel de Controle Empresa"/></td>
                     ...
                     <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                         <td width="230" valign="top" class="list_restrita_empresa">
                             <%//@include file="includes_html/menu_restrito_empresa.inc" %>
...
//loRS.Open "SELECT DataValidade, NPlano, Negociacoes FROM Assinaturas WHERE NEmpresa=" & Session("Empresa-NEmpresa") , loConexao
//If Not loRS.Eof Then
	
//			'loRS2.Open "SELECT Negociacoes, NPlano FROM Planos WHERE NPlano = " & loRS("NPlano"), loConexao
//					'loTotalNogociacoes = loRS2("Negociacoes")
//			'loRS2.Close
						
//			IF loRS("Negociacoes") <= 0 Then
%>			
				<td valign="top" align="center">Seu Plano Expirou, para renovar seu plano <a href="lista_planos.jsp">Clique Aqui</a>!!!</td>
<%                
//			Else
%>
				<td> </td>
...
//	'Else			
//			'loDataEx = loRS("DataValidade") - loData
			
			
//				'If loRS("DataValidade") < loData Then
%>

				<td valign="top" align="center">Sua Assinatura que expirou no dia  <% //='loRS("DataValidade")%>, para renovar seu plano <a href="lista_planos.jsp">Clique Aqui</a>!!!</td>
<%

//				'ElseIf loDataEx <= 5 Then
			 
%>
				<td valign="top" align="center">Seu Plano Expira em <%//'=loDataEx%> Dias!!!</td>
<%
