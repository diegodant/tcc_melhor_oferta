                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                                                ...
                                                <td>
                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr>
                                                            <td class="titu_sol"><h1>Acompanhamento de Solicitação</h1></td>
                                                          </tr>
                                                          <tr>
                                                            <td>&nbsp;</td>
                                                          </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                              ...
                                                              <tr>
                                                                <td width="170" align="right" class="txt_soli">Produto/Servi&ccedil;o:</td>
                                                                <td class="txt_solicitacao"><p>&nbsp;</p></td>
                                                           </tr>
                                                              <tr>
                                                                <td>&nbsp;</td>
                                                                <td>&nbsp;</td>
                                                              ...
                                                              <tr>
                                                                <td align="right" valign="top" class="txt_soli">Categorias Relacionadas:</td>
                                                                <td class="txt_solicitacao"><p>&nbsp;</p></td>
                                                              </tr>
                                                              <tr>
                                                                <td>&nbsp;</td>
                                                              ...
                                                              <tr>
                                                                <td align="right" class="txt_soli">3&ordf;s categorias relacionada:</td>
                                                                <td class="txt_solicitacao"><p>&nbsp;</p></td>
                                                              </tr>
                                                              <tr>
                                                                <td>&nbsp;</td>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td>
                                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      <tr>
                                                                        <td width="10">&nbsp;</td>
                                                                        <td><input type="image" name="imageField" id="imageField" src="imagens/melhor_oferta/bt_acompanhar.jpg" /></td>
                                                                      </tr>
                                                                    </table>
                                                                </td>
                                                              </tr>
