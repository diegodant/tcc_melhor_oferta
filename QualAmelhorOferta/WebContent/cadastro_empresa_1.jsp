...
document.getElementById('razao').style.display='';
                        								...
                        								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          ...
                                                          <tr>
                                                            <td>
                                                              ...
                                                              <tr>
                                                                <td width="190" align="right" class="txt_soli">Tipo Pessoa*:</td>
                                                                <td>
                                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                     <td class="txt_soli">&nbsp;&nbsp;
                                                                        ...
                                                                        <input checked="checked" name="tipo" type="radio" value="juridica" onclick="pf()" /> 
                                                            ...
                                                            <tr id="razao">
                                                                <td align="right" class="txt_soli" valign="top">Raz&atilde;o Social:</td>
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    <td width="10">&nbsp;</td>
                                                                    ...
                                                                    <td width="100">
									<input name="razao" type="text" class=" form_sol" id="razao" size="65" maxlength="300" onkeypress="mascara(this,razao)" /></td>
                                                              ...
                                                              <tr>
                                                                <td align="right" class="txt_soli" valign="top">Nome Fantasia:</td>
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    <td width="10">&nbsp;</td>
                                                                    <td width="12" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="100">
									<input name="fantasia" type="text" class=" form_sol" id="fantasia" size="65" maxlength="300"/></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Mlehor Oferta" /></td>
                                                                    <td>&nbsp;</td>
                                                                  </tr>
                                                                </table>
                                                              ...
                                                              <tr id="responsavel">
                                                                <td align="right" class="txt_soli" valign="top">Respons&aacute;vel*:</td>
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    <td width="10">&nbsp;</td>
                                                                    <td width="12" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="100">
									<input name="responsavel" type="text" class=" form_sol" id="responsavel" size="65" maxlength="300"  onkeypress="mascara(this,responsavel)"/></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Mlehor Oferta" /></td>
                                                                    <td>&nbsp;</td>
                                                                  </tr>
                                                                </table>
                                                                ...
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    ...
                                                                    <td width="12" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="100">
									<input name="vendedor" type="text" class=" form_sol" id="vendedor" value="<% out.print(u.getNome()); %>" size="65" maxlength="300"/></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Mlehor Oferta" /></td>
                                                                    <td>&nbsp;</td>
                                                                  </tr>
                                                                </table>
                                                                ...
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    ...
                                                                    <td width="12" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="70">
								    <input name="cpf" type="text" class=" form_sol" value="<% out.print(u.getDocumento()); %>" size="25" maxlength="14" onkeypress="mascara(this,cpf)" /></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Melhor Oferta" /></td>
                                                              ...
                                                              <tr>
                                                                  <td width="190" align="right" class="txt_soli">Telefone*:</td>
                                                                  <td>
                                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    <td width="10">&nbsp;</td>
                                                                    <td width="30" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="74">
									<input type="text" name="telefone" size="12" class=" form_sol" value="<% out.print(u.getTelefone()); %>"></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Mlehor Oferta" /></td>
                                                                    <td width="372" class="txt_soli">&nbsp;Ex: 99 9999-9999</td>
                                                                  </tr>
                                                                </table>
                                                                </td>
                                                              </tr>
                                                                ...
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    ...
                                                                    <td width="12" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="70">
								    <input type="text" name="Cep" size="12" class=" form_sol" value="<% out.print(u.getCep()); %>" maxlength="9" /></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Melhor Oferta" /></td>
                                                                ...
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    ...
                                                                    <td width="12" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="100">
								   <input name="endereco" type="text" value="<% out.print(u.getRua()); %>" size="60" maxlength="300" class=" form_sol"></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Mlehor Oferta" /></td>
                                                                    <td>&nbsp;</td>
                                                                  </tr>
                                                                </table>
                                                                ...
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    ...
                                                                    <td width="12" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="80">
                                                                        <input type="text" name="bairro" size="25" value="<% out.print(u.getBairro()); %>" class=" form_sol"></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Mlehor Oferta" /></td>
                                                                    <td>&nbsp;</td>
                                                                  </tr>
                                                                </table>
                                                                ...
                                                                <td>
                                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                    ...
                                                                    <td width="12" align="right"><img src="imagens/cadastro_usuario/ct_form_e_l.jpg" width="11" height="21" alt="Melhor Ofeta" /></td>
                                                                    <td width="80">
									<input name="cidade" type="text" class=" form_sol" value="<% out.print(u.getCidade()); %>" size="50" maxlength="50"></td>
                                                                    <td width="11"><img src="imagens/cadastro_usuario/ct_form_d_l.jpg" width="11" height="21" alt="Mlehor Oferta" /></td>
                                                                    <td>&nbsp;</td>
                                                                  </tr>
                                                                </table>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td>
                                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      <tr>
                                                                        <td width="10">&nbsp;</td>
                                                                        <td align="center"><!--<input type="image" name="imageField" id="imageField" src="imagens/cadastro_usuario/bt_enviar.jpg" />-->
