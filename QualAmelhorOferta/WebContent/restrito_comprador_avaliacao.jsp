 ...
 */ %>
					 ...
					 <tr>
                       <td align="center"> <strong>Avaliações Recebidas </strong></td>
                    </tr>	
                    <tr>
                       <td>&nbsp;</td>
                    </tr>
...
Else
 */ %>
	<tr><td>Você não possui nenhuma Solicitação avaliada.</td></tr>
<% /* 
End If
loRS.Close
 ...
 */ %>
					 ...
					 <tr>
                       <td align="center"> <strong>Avaliações Efetuadas </strong></td>
                    </tr>	
                    <tr>
                       <td>&nbsp;</td>
                    </tr>
...
Else
 */ %>
	<tr><td>Você não avaliou nenhuma Solicitação até o momento.</td></tr>
<% /* 
End If
loRS.Close
loConexao.Close
