...
loRS.Open "SELECT Nome, Comentario, A.NSolicitacao, Atendimento, Qualidade, EConfiabilidade FROM Avaliacoes A INNER JOIN Usuarios U ON A.NUsuario = U.NUsuario WHERE A.Ativo = 1 AND Avaliado = 2 AND A.NEmpresa = " & Request("paNEmpresa") & " ORDER BY NAvaliacao DESC", loConexao
...
<% /* 
	loRS2.Open "Select * FROM Empresas WHERE NEmpresa=" & Request("paNEmpresa"), loConexao

	loFoto = Application("DirEmpresas") & "Logo" & Request("paNEmpresa") & ".jpg"
		If ExisteArq(loFoto) Then
	 */ %>
			 <tr>
             	<td align="center" class="avali">	 <img src="foto.jsp?paTipo=Logo&paFoto=Logo<% /* =Request("paNEmpresa") */ %>.jpg&paPorcent=40" alt="<% /* =loRS2("NomeFantasia") */ %>" /> <td>
             </tr>
	<% /* 
		End if
	 */ %>		                               
                                       ...
                                       <tr>
                                         <td align="center" class="avali"><% /* =loRS2("NomeFantasia") */ %></td>
                                       </tr>
 ...
 */ %>
    ...
    <td valign="top"><%@include file="includes_html/nuvem_tags.jsp" %></td>
  </tr>
</table>
