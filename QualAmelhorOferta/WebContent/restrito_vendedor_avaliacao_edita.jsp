...
If Request("paNSolicitacao") <> "" And IsNumeric(Request("paNSolicitacao")) Then
	...
	If Not loRS.Eof Then
		...
		If loRS("Status") = 2 Then
			...
			loRS2.Open "SELECT Comunicacao, UConfiabilidade, Comentario FROM Avaliacoes WHERE Ativo = 1 AND NSolicitacao = " & loRS("NSolicitacao") & " AND Avaliado = 1", loConexao
	...
	Else
		Response.Redirect "restrito_acompanhar_solicitacao_comprador.jsp"
                     ...
                     <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                         ...
                         <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                             <td>
					<form action="avaliacao_vendedor_grava.jsp" method="post" name="FormularioWLD" >
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                               <tr>
                                 <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                   <tr>
 ...
 */ %>
                                          <tr>
                                            <td><input name="Comentario" type="text" style="width: 485px; height: 135px" value="" maxlength="500" /></td>
                                          </tr>
<% /* 
Else
 */ %>
 ...
 */ %>
                                          ...
                                          <tr>
                                            <td><h1>Avaliações do Usuário.</h1></td>
                                          </tr>
                                          <tr>
                                            <td>&nbsp;</td>
                                          </tr>
 ...
 */ %>
													<tr>
														...
														Comunicação do Cliente:</td>
														<td>
														<input name="Comunicacao" type="text" value="" size="1" /> 
														Nota de 1 a 5</td>
													</tr>
													<tr>
														<td style="width: 167px">
														Confiabilidade:</td>
														<td>
														<input name="UConfiabilidade" type="text" value="" size="1" /> 
														Nota de 1 a 5</td>
													</tr>
													<tr>
														<td style="width: 167px">&nbsp;
														...
														<td>
														<input type="image" name="imageField" id="imageField" src="imagens/bt_enviar.jpg" /><input name="NSolicitacao" type="hidden" value='<% /* =Request("paNSolicitacao") */ %>' /></td>
													</tr>
<% /* 
Else
 */ %>
