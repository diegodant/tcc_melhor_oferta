...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><font face="Arial, Helvetica, sans-serif" color="#999999"  size="2">Olá, <% /* =Request("Nome") */ %></font></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  <tr>
    <td><font face="Arial, Helvetica, sans-serif" color="#999999"  size="2">Parabéns, seu cadastro foi efetuado com sucesso. Complete seu cadastro, incluindo as categorias que deseja atender. Clique no link abaixo:</font></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><font face="Arial, Helvetica, sans-serif" size="2"><a href="http://www.melhoroferta.net/home/restrito_altera_dados_empresa.jsp">http://www.melhoroferta.net/home/restrito_altera_dados_empresa.jsp</a></font></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
