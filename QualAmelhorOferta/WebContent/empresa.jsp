    ...
    <td>
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="115"><img src="imagens/titu_empresa.jpg" width="95" height="19" alt="Quero a Melhor Oferta" title="Quero a Melhor Oferta" border="0" /></td>
               <td class="li">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td>
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td class="empresa">
                                 <p>A Empresa MelhorOferta.net foi criado para suprir a necessidade do comprador de receber as melhores ofertas sem que precise pesquisar e procurar na Internet e no mercado para os melhores Vendedores ou prestadores de serviço.</p>
                                 
                                 <p>Para o Vendedor a MelhorOferta.net também traz maiores possibilidades de alcançar o cliente realmente interessado em seu produto ou serviço sem altos gastos em divulgação.</p>
                                 
                                 <p>Missão: Facilitar a vida do comprador em encontrar a melhor oferta e do vendedor em encontrar compradores interessados em seu produto ou serviço, poupando tempo, recurso e energia.</p>
  
                                 <p>Visão: Ser o maior Portal Brasileiro que une de forma ágil e econômica compradores e vendedores via Internet.</p>                               
                                </td>
                              </tr>
                            </table>
                        </td>
